    ...
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-8 justify-center">
                ...
                <h1 class="text-4xl font-bold gradient-text roboto-bold">Create new post</h1>
            </div>
            ...
            <!-- Subtle decoration -->
            <p class="text-center text-xs text-gray-600 mt-8">Your thoughts matter. Share them.</p>
        </div>
    </div>
@endsection
